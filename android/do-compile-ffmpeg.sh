...
FF_TOOLCHAIN_PATH=$FF_BUILD_ARCH/toolchain

FF_SYSROOT=$FF_TOOLCHAIN_PATH/sysroot

FF_ARCH_OUTPUT=$FF_OUTPUT_ROOT/$FF_ARCH

FF_PREFIX=$FF_ARCH_OUTPUT/$FF_BUILD_NAME
FF_DEP_OPENSSL_INC=$FF_ARCH_OUTPUT/$FF_BUILD_NAME_OPENSSL/include
FF_DEP_OPENSSL_LIB=$FF_ARCH_OUTPUT/$FF_BUILD_NAME_OPENSSL/lib
FF_DEP_LIBSOXR_INC=$FF_ARCH_OUTPUT/$FF_BUILD_NAME_LIBSOXR/include
FF_DEP_LIBSOXR_LIB=$FF_ARCH_OUTPUT/$FF_BUILD_NAME_LIBSOXR/lib

FF_DEP_LIBX264_INC=$FF_ARCH_OUTPUT/$FF_BUILD_NAME_LIBX264/include
FF_DEP_LIBX264_LIB=$FF_ARCH_OUTPUT/$FF_BUILD_NAME_LIBX264/lib
...
if [ "$RELEASE" = true ]; then
    $STRIP --strip-unneeded $FF_PREFIX/libffmpeg.so -o $FF_PREFIX/libffmpeg_release.so
fi
